node{
    ...
    stage("Load Testing"){
        sh 'artillery run -o report.xml perfTest.yml'
    ...
    stage("Publishing Reports"){
        ...
        publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: false, reportDir: '', reportFiles: 'report.json.html', reportName: 'Load Testing Report', reportTitles: ''])
